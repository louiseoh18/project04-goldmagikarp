...
# add data pulls and any other necessary setup code here
```

```{r}
#| context: server

# shiny code for server here
```

```{r}
# shiny input code, might be good to make separate cards to place above two plots
# can choose whatever president you want for each
```

```{r}
# plot outputs --> will likely have two of these
```
