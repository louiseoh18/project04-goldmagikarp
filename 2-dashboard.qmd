...
# TO-DO:
# Reference page: Add remaining reference (missing ANES) + packages. Can maybe format into columns for better aesthetics (minimize white space).
```
...
**All Data Sources and Software Packages** <br>

<style>
/* 1. Remove extra vertical space, using a small margin to stabilize layout */
.csl-entry {
  margin-bottom: 2px !important; 
  padding-bottom: 0 !important;
}

/* 2. TARGET THE GENERATED LIST (<ol>) TO FORCE COLUMNS */
.references ol {
  /* Critical: Forces the list into a block that supports columns */
  display: block !important; 
  
  /* Apply column rules to the list itself */
  column-count: 3 !important;
  column-gap: 50px !important; 
  
  /* Prevent breaks within a citation item */
