...
div(class = "alert-primary", 
    style = "display: flex; flex-direction: column; justify-content: center; align-items: center; height: 80px; text-align: center;",
    h6(HTML("Party:<br>"), style = "color: white; margin: 0;",
       span(textOutput("party_text", inline = TRUE), style = "color: white; font-weight: bold; font-size: 1.5em;")))
```
